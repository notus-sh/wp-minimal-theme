 ...
 */
function mt_site_logo( $args = array(), $echo = true ) {
	...
	/**
	 * Filters the arguments for `mt_site_logo()`.
	 *
	 * @param array  $args     Parsed arguments.
	 * @param array  $defaults Function's default arguments.
	 */
	$args = apply_filters( 'mt_site_logo_args', $args, $defaults );
	 ...
	 */
	$html = apply_filters( 'mt_site_logo', $html, $args, $classname, $contents );
 ...
 */
function mt_site_description( $echo = true ) {
	 ...
	 */
	$html = apply_filters( 'mt_site_description', $html, $description, $wrapper );
 ...
 * @return bool
 */
function mt_is_comment_by_post_author( $comment = null ) {
...
function mt_the_post_meta( $post_id = null, $location = 'single-top' ) {
	...
	echo mt_get_post_meta( $post_id, $location ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped in mt_get_post_meta().
...
function mt_edit_post_link( $link, $post_id, $text ) {
	...
	return '<div class="post-meta-wrapper post-meta-edit-link-wrapper"><ul class="post-meta"><li class="post-edit meta-wrapper"><span class="meta-icon">' . mt_get_theme_svg( 'edit' ) . '</span><span class="meta-text"><a href="' . esc_url( $edit_url ) . '">' . $text . '</a></span></li></ul><!-- .post-meta --></div><!-- .post-meta-wrapper -->';
			...
			<ul class="post-meta<?php echo esc_attr( $post_meta_classes ); ?>">
				...
				if ( in_array( 'sticky', $post_meta, true ) && is_sticky() ) {
					...
					<li class="post-sticky meta-wrapper">
						<span class="meta-icon">
							<?php mt_the_theme_svg( 'bookmark' ); ?>
						</span>
						<span class="meta-text">
							<?php _e( 'Sticky post', 'mt' ); ?>
						</span>
					</li>
					<?php
...
function mt_add_sub_toggles_to_main_menu( $args, $item, $depth ) {
	...
	if ( isset( $args->show_toggles ) && $args->show_toggles ) {
		...
		if ( in_array( 'menu-item-has-children', $item->classes, true ) ) {
			...
			$args->after .= '<button class="toggle sub-menu-toggle fill-children-current-color" data-toggle-target="' . $toggle_target_string . '" data-toggle-type="slidetoggle" data-toggle-duration="' . absint( $toggle_duration ) . '" aria-expanded="false"><span class="screen-reader-text">' . __( 'Show sub menu', 'mt' ) . '</span>' . mt_get_theme_svg( 'chevron-down' ) . '</button>';
