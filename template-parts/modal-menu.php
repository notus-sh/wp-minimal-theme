    ...
    <div class="menu-wrapper section-inner">
      ...
      <div class="menu-top">
        ...
        <button class="toggle close-nav-toggle fill-children-current-color" data-toggle-target=".menu-modal"
          ...
          if (has_nav_menu('expanded')) {
            ...
            <nav class="expanded-menu<?php
            echo esc_attr($expanded_nav_classes); ?>" aria-label="<?php
            esc_attr_e('Expanded', 'mt'); ?>" role="navigation">
          ...
          if ('expanded' !== $mobile_menu_location) {
            ...
            <nav class="mobile-menu" aria-label="<?php
            esc_attr_e('Mobile', 'mt'); ?>" role="navigation">
      ...
      <div class="menu-bottom">
          ...
          if (has_nav_menu('social')) { ?>
            ...
            <nav aria-label="<?php
            esc_attr_e('Expanded Social links', 'mt'); ?>" role="navigation">
