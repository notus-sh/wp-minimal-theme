		...
		public static function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'description' => __( 'Scales the logo to half its uploaded size, making it sharp on high-res screens.', 'mt' ),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'header_footer_background_color',
					array(
						'label'   => __( 'Header &amp; Footer Background Color', 'mt' ),
						'section' => 'colors',
					)
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					'type'    => 'radio',
					'section' => 'colors',
					'label'   => __( 'Primary Color', 'mt' ),
					'choices' => array(
						'default' => __( 'Default', 'mt' ),
						'custom'  => __( 'Custom', 'mt' ),
					),
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					array(
						'section'         => 'colors',
						'settings'        => 'accent_hue',
						'description'     => __( 'Apply a custom color for links, buttons, featured images.', 'mt' ),
						'mode'            => 'hue',
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'Show search in header', 'mt' ),
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'section'  => 'options',
					'priority' => 10,
					'label'    => __( 'On archive pages, posts show:', 'mt' ),
					'choices'  => array(
						'full'    => __( 'Full text', 'mt' ),
						'summary' => __( 'Summary', 'mt' ),
					),
				)
			);
			...
			$wp_customize->add_section(
				...
				array(
					'title'       => __( 'Cover Template', 'mt' ),
					'capability'  => 'edit_theme_options',
					'description' => __( 'Settings for the "Cover Template" page template. Add a featured image to use as background.', 'mt' ),
					'priority'    => 42,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'       => __( 'Fixed Background Image', 'mt' ),
					'description' => __( 'Creates a parallax effect when the visitor scrolls.', 'mt' ),
				)
			);
			...
			$wp_customize->add_setting(
				...
				array(
					'default'           => mt_get_color_for_area( 'content', 'accent' ),
					'sanitize_callback' => 'sanitize_hex_color',
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_background_color',
					array(
						'label'       => __( 'Overlay Background Color', 'mt' ),
						'description' => __( 'The color used for the overlay. Defaults to the accent color.', 'mt' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				new WP_Customize_Color_Control(
					...
					'cover_template_overlay_text_color',
					array(
						'label'       => __( 'Overlay Text Color', 'mt' ),
						'description' => __( 'The color used for the text in the overlay.', 'mt' ),
						'section'     => 'cover_template_options',
					)
				)
			);
			...
			$wp_customize->add_control(
				'cover_template_overlay_opacity',
				array(
					'label'       => __( 'Overlay Opacity', 'mt' ),
					'description' => __( 'Make sure that the contrast is high enough so that the text is readable.', 'mt' ),
					'section'     => 'cover_template_options',
					'type'        => 'range',
 ...
 */
function mt_customize_opacity_range() {
	/**
